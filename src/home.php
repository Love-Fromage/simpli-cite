...
<section class="about">
	...
	<div class="home-cont-about">
		<div class="home-about-para-d">
			<div class="col-left">
				<p>
					<?php lang('Notre programme de location de véhicule moyen terme
							...
							période déterminé, un besoin saisonnier, une
			...
			<div class="col-right">
				<div class="home-overlay">
					...
					<p>
						<?php lang("Chez Simpli-Cité nous vous offrons la
								...
								plusieurs années sans savoir quand seras le
								nouveau projet qui nécessite un véhicule de
								travaille. Fini également les frais d’entretien
								mécanique élevés dû à un véhicule vieillissant
				...
				<div class="cont-img">
					<img src="./images/home-mobile.webp" alt="home-mobile" />
				</div>
			</div>
		</div>
		<div class="home-about-para-d-2">
			<div class="d2-cont">
				<div class="col-g">
					<div class="cont-p-top">
						<p>
							<?php lang("Notre programme de location de véhicule
									...
									ce soit pour un chantier à période
									déterminé, un besoin saisonnier, une
						...
						<p>
							<?php lang("Fort de notre expérience dans les domaines
									...
									entreprises au niveau de leurs parc
					...
					<div class="boite-grise">
						...
						<p>
							<?php lang("Choisir Simpli-Cité c’est choisir la
									...
									Maintenir un parc automobile permanent n’est
						...
						<p>
							<?php lang("Chez Simpli-Cité nous vous offrons la
									...
									les engagements sur plusieurs années sans
									savoir quand seras le nouveau projet qui
									nécessite un véhicule de travaille. Fini
									également les frais d’entretien mécanique
									élevés dû à un véhicule vieillissant et qui
				...
				<div class="col-d">
					<div class="cont-img">
						<img src="./images/home-about-d.webp" alt="home-mobile" />
						<div class="col-droite"></div>
					</div>
				</div>
			</div>
	...
	<div class="home-cont-voiture">
		<!-- <img src="../images/voiture-home-mobile.webp" alt="lechar"> -->
