...
<div class="veh-hero"></div>
		...
		<section class="veh-extra">
			...
			<div class="veh-btn-contact btn-color btn-l-r">
				<a href="/contact.html" class="veh-btn-contact"
					><?php lang('contactez-nous','contact us'); ?></a
				>
			</div>
		</section>
